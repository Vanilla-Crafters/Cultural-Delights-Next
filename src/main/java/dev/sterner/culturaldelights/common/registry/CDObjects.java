...
public class CDObjects {
    ...
    public static final Item HEARTY_SALAD = register("hearty_salad", new SuspiciousStewItem(settings().food(CDFoodComponents.HEARTY_SALAD)));
    ...
    public static final Item FRIED_EGGPLANT_PASTA = register("fried_eggplant_pasta", new SuspiciousStewItem(settings().food(CDFoodComponents.FRIED_EGGPLANT_PASTA)));
    ...
    public static final Item CREAMED_CORN = register("creamed_corn", new SuspiciousStewItem(settings().food(CDFoodComponents.CREAMED_CORN)));
    public static final Item CHICKEN_TACO = register("chicken_taco", new Item(settings().food(CDFoodComponents.CHICKEN_TACO)));
    public static final Item SPICY_CURRY = register("spicy_curry", new SuspiciousStewItem(settings().food(CDFoodComponents.SPICY_CURRY)));
...
*/
    ...
    public static final Block AVOCADO_SAPLING = register("avocado_sapling", new SaplingBlock(new SaplingGenerator("avocado_sapling", Optional.empty(), Optional.empty(), Optional.empty()), FabricBlockSettings.copy(Blocks.OAK_SAPLING)), settings(), true);
    ...
    public static final Block AVOCADO_PIT = register("avocado_pit", new AvocadoPitBlock(new SaplingGenerator("avocado_sapling", Optional.empty(), Optional.empty(), Optional.empty()), FabricBlockSettings.copy(Blocks.OAK_SAPLING)), settings(), true);

    public static final Block AVOCADO_CRATE = register("avocado_crate", new Block(FabricBlockSettings.copy(ModBlocks.CARROT_CRATE.get())), settings(), true);
    public static final Block CUCUMBER_CRATE = register("cucumber_crate", new Block(FabricBlockSettings.copy(ModBlocks.CARROT_CRATE.get())), settings(), true);
    public static final Block PICKLE_CRATE = register("pickle_crate", new Block(FabricBlockSettings.copy(ModBlocks.CARROT_CRATE.get())), settings(), true);
    public static final Block CORN_COB_CRATE = register("corn_cob_crate", new Block(FabricBlockSettings.copy(ModBlocks.CARROT_CRATE.get())), settings(), true);
    public static final Block EGGPLANT_CRATE = register("eggplant_crate", new Block(FabricBlockSettings.copy(ModBlocks.CARROT_CRATE.get())), settings(), true);
